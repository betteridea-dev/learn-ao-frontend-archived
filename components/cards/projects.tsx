  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 items-center">
      {projects.map((project: Project) => (
        <div className="bg-[#E9FF91] h-[220px] p-[30px] rounded-lg flex flex-col gap-3 relative">
          <div className="text-zinc-950 text-xl font-bold font-plus-jakarta-sans leading-normal">
            {project.name}
          </div>
          <div className="text-zinc-950 text-base font-normal font-plus-jakarta-sans leading-tight">
            {project.description}
          </div>
